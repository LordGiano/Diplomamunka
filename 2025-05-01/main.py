...
def process_video(video_path: str, mask_gen_type: str, inpainting: bool):
    """
    ...
    base_mask = None
    if mask_gen_type == 'median':
        img_backgroung = median_background.create_median_background(video_path, 200)
        base_mask = median_mask.create_movement_mask(video_path, img_backgroung, 30)
    else:
        base_mask = KNN_mask.process_video(video_path)
...
if __name__ == "__main__":
    process_video(r"C:/Programozás/Diplomamunka/videos/Rat5/04.12.01-04.13.41[M][0@0][0].dav", "median", True)